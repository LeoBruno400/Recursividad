...
public class Problema11 {
    ...
    public static int sumaPosicionesPares(int[] arreglo, int i, int longitud) {
        ...
        if (i < longitud) {
            ...
            //Caso base: contadorPar se va a setear con el ultimo valor par y se va a sumar con el acarreado
        }
        return contadorPar;
    }
    public static int sumaPosicionesImpares(int[] arreglo, int i, int longitud) {
        ...
        //Condicion impar: i tiene que arracar en la primera posicion impar del arreglo, osea 1
        if(i==0){
            i = 1;
        }
        ...
        if (i < longitud) {
            ...
            //Caso base: contadorImpar se va a setear con el ultimo valor impar y se va a sumar con el acarreado
        }
